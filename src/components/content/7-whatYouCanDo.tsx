				...
				<div>
					...
					<div className="grid grid-cols-1 gap-8 md:grid-cols-2">
						...
						<div className="flex items-center gap-6">
							...
							<p className="text-left italic">Have an emergency kit ready with supplies</p>
						</div>
						{/* Item 2 */}
						<div className="flex items-center gap-6">
							<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
				...
				<div>
					...
					<div className="grid grid-cols-1 gap-8 md:grid-cols-2">
						...
						<div className="flex items-center gap-6">
							...
							<p className="text-left italic">Avoid crowds of people.</p>
						</div>
						{/* Item 4 */}
						<div className="flex items-center gap-6">
							<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
							...
							<p className="text-left italic">Do not share food, water, or utensils.</p>
						</div>
						{/* Item 5 */}
