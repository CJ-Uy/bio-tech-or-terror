		...
		<div>
			...
			<div className="[&>*]:[&_div]:font-dm_sans block h-auto md:flex md:px-25 [&>*]:mx-auto [&>*]:block [&>*]:overflow-auto [&>*]:[&>*]:px-10 [&>*]:[&>*]:py-5 [&>*]:[&>*]:text-justify [&>*]:md:w-1/2 [&>*]:[&_div]:text-lg">
				<div>
					...
					<h2 className="font-koulen text-2xl">Government and Institutions</h2>
					<div>
						The governmen&apos;s role is vital in preparing and responding against bioterrorism and
					...
					<div className="my-0 !py-0 [&>*]:my-5 [&>*]:!px-1 [&>*]:!py-1">
						<MainListItem number="1" title="Public Awareness" hasSublist={true} />
						...
						<MainListItem number="2" title="Pest Control" hasSublist={true} />
						<SubListItem text="Initiate measures of insects and rodent control." />
						<MainListItem number="3" title="Clinic and Laboratory Measures" hasSublist={true} />
					...
					<h2 className="font-koulen text-2xl">Scientific and Health Care Professionals</h2>
					<div>
				...
				<div>
					...
					<h2 className="font-dm_sans !pb-0 text-xl italic">II. Veterinary Surveillance</h2>
					<div>
					...
					<h2 className="font-dm_sans !pb-0 text-xl italic">IV. Medical Intelligence</h2>
					<div>
