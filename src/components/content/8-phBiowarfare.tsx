			...
			<div className="[&>*]:[&_div]:font-dm_sans block h-auto md:flex md:px-25 [&>*]:mx-auto [&>*]:block [&>*]:overflow-auto [&>*]:[&>*]:px-10 [&>*]:[&>*]:py-5 [&>*]:[&>*]:text-justify [&>*]:md:w-1/2 [&>*]:[&_div]:text-lg">
				...
				<div>
					<div>
						...
						the delegation prepared and oversaw the Association of Southeast Asian Nations&apos;
						(ASEAN) Joint Statement&apos;s approval (Domingo, 2023).
					</div>
					<div>
						...
						United States&apos; Defense Threat Reduction Agency (DTRA), through its Cooperative
						Threat Reduction (CTR) Program, met with representatives from the Department of Health
						(DOH), the Department of Agriculture (DA), the Department of Science and Technology
						(DOST), and the Department of Interior and Local Government (DILG). In order to help the
						Philippines prepare for and defend against biothreat agents, the CTR Program commits to
						support activities that enhance interagency systems, communication, and other capacities
						over the course of the following five years.
					</div>
					<div>
						Recently, March 17 to 19, 2025, the Philippine Army held the country&apos;s first
						Chemical, Biological, Radiological, and Nuclear (CBRN) warfare summit. During the
						summit, cohesive and strategic approaches were formulated to enhance the army&apos;s
						CBRN defense capabilities, including biological threats. The Philippine Army was
						expected to strengthen its readiness, intelligence, and collaboration against CBRN
						threats.
					</div>
				</div>
