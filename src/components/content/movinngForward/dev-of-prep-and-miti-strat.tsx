			...
			<div className="[&>*]:[&_div]:font-dm_sans block h-auto md:flex md:px-25 [&>*]:mx-auto [&>*]:block [&>*]:overflow-auto [&>*]:[&>*]:px-10 [&>*]:[&>*]:py-5 [&>*]:[&>*]:text-justify [&>*]:md:w-1/2 [&>*]:[&_div]:text-lg">
					...
					<div className="grid grid-cols-1 gap-8">
						<div className="grid grid-cols-2">
							...
							<div className="flex items-center gap-6">
								...
								<p className="text-left italic">Increased vigilance</p>
							</div>
							{/* Item 2 */}
							<div className="flex items-center gap-6">
								<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
								...
								<p className="text-left italic">Detection devices</p>
							</div>
						</div>
						<div className="grid grid-cols-2">
							{/* Item 3 */}
							<div className="flex items-center gap-6">
								...
								<p className="text-left italic">Diagnostics</p>
							</div>
							{/* Item 4 */}
							<div className="flex items-center gap-6">
								<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
								...
								<p className="text-left italic">Vaccines</p>
							</div>
						</div>
						<div className="grid grid-cols-2">
							{/* Item 5 */}
							<div className="flex items-center gap-6">
								...
								<p className="text-left italic">Drugs</p>
							</div>
							{/* Item 6 */}
							<div className="flex items-center gap-6">
								<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
									<span className="font-sans text-4xl font-bold text-black">6</span>
								</div>
								<p className="text-left italic">Therapeutic immunoglobulins</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div>
					...
					<div className="flex flex-row-reverse items-center gap-6">
						...
						<p className="text-left italic">Mortality</p>
					</div>
					...
					<div className="flex flex-row-reverse items-center gap-6">
						...
						<p className="text-left italic">Need for hospitalization</p>
					</div>
					{/* Item 3 */}
					<div className="flex flex-row-reverse items-center gap-6">
						<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
						...
						<p className="text-left italic">Likelihood for dissemination</p>
					</div>
					{/* Item 4 */}
					<div className="flex flex-row-reverse items-center gap-6">
						<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
						...
						<p className="text-left italic">Availability of countermeasures</p>
					</div>
					{/* Item 5 */}
					<div className="flex flex-row-reverse items-center gap-6">
						<div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#89F6CB] to-[#509077]">
						...
						<p className="text-left italic">Public perception</p>
					</div>
				</div>
			</div>
	)
