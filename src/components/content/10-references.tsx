export default function References() {
	...
	return (
		<div>
			...
			<div className="[&>*]:[&_div]:font-dm_sans block h-auto md:flex md:px-25 [&>*]:mx-auto [&>*]:block [&>*]:overflow-auto [&>*]:[&>*]:px-10 [&>*]:[&>*]:py-5 [&>*]:[&>*]:text-justify [&>*]:md:w-2/3 [&>*]:[&_div]:text-lg">
				<div className="mt-4">
					<ul className="list-outside space-y-4">
