			...
			{qIndex === -1 ? (
				...
				<div className="flex flex-grow flex-col items-center justify-center px-4 text-center">
					...
					<p className="mb-8 max-w-2xl text-justify">
						In this short simulation, go over the decisions scientists had to make as they developed
						the first COVID-19 vaccine comparing them to your very own. Get a sense of how important
						prior research is in every choice. There are no right or wrong answers. Step into their
						shoes of uncertainty and lack of hindsight to make critical decisions to save the world!
					</p>
